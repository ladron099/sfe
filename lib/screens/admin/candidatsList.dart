...
import 'package:permis/screens/admin/editCandidat.dart';
...
class CandidatsList extends StatefulWidget {
  const CandidatsList({Key? key}) : super(key: key);

  @override
  State<CandidatsList> createState() => _CandidatsListState();
}

class _CandidatsListState extends State<CandidatsList> {
  List test =[];
  ...
  bool loading=true;
   ...
   getSchools() async {
    ...
    var bod = await a.getCandidat(token);
    setState(() {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            15.verticalSpace,
TextField(
     key: const GlobalObjectKey('candidat'),
                onChanged: (value) {
                  if (value.isEmpty) {
                    pic = [];
                    schoolName = [];
                          ...
                          child: FocusedMenuHolder(
                            ...
                            fontSize: 14.sp,
                              ...
                              FocusedMenuItem(title: LocaleText("Delete",style: TextStyle(
                                ...
                                print(id[i]);
                                DeletePopup(context, Locales.string(context, 'accountdelete'),id[i],'candidat',AdminHomePage(index: 0));
