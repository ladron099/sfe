...
class CoachAdd1 extends StatefulWidget {
  const CoachAdd1({Key? key}) : super(key: key);

  @override
  State<CoachAdd1> createState() => _CoachAdd1State();
}

class _CoachAdd1State extends State<CoachAdd1> {
...
print(SelectedId);
            ...
            Navigator.push(
                context, MaterialPageRoute(builder: (context) => const AddCoach2()));
           }
          },
          label: LocaleText(
            "continue",
