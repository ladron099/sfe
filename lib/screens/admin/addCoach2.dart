...
class AddCoach2 extends StatefulWidget {
  const AddCoach2({Key? key}) : super(key: key);

  @override
  State<AddCoach2> createState() => _AddCoach2State();
}

class _AddCoach2State extends State<AddCoach2> {
      ...
      floatingActionButton: SizedBox(
        ...
        child: FloatingActionButton.extended(
          ...
          onPressed: () async {
            ...
            Navigator.push(
                context,
                MaterialPageRoute(builder: (context) =>  const AddCoach3()));
               }
          },
          label: LocaleText(
            "continue",
