...
class SchoolCoachProfile extends StatefulWidget {
  int id;
    SchoolCoachProfile({required this.id, Key? key}) : super(key: key);

  @override
  State<SchoolCoachProfile> createState() => _SchoolCoachProfileState(id);
}

class _SchoolCoachProfileState extends State<SchoolCoachProfile> {
  ...
  String tarifs = '';
  int id ;
  _SchoolCoachProfileState(this.id);
getData() async {
