...
import 'package:permis/screens/autoecole/SchoolAddCandidat3.dart';
import 'package:shared_preferences/shared_preferences.dart';

import '../../const/vars.dart'; 

class SchoolAddCandidat2 extends StatefulWidget {
  const SchoolAddCandidat2({Key? key}) : super(key: key);

  @override
  State<SchoolAddCandidat2> createState() => _SchoolAddCandidat2State();
}

class _SchoolAddCandidat2State extends State<SchoolAddCandidat2> {
      ...
      floatingActionButton: SizedBox(
        ...
        child: FloatingActionButton.extended(
          ...
          onPressed: () async {
            ...
            Navigator.push(
                context,
                MaterialPageRoute(builder: (context) =>  const SchoolAddCandidat3()));
               }  
          },
          label: LocaleText(
            "continue",
