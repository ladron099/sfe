...
class SchoolAddCoach3 extends StatefulWidget {
  const SchoolAddCoach3({Key? key}) : super(key: key);

  @override
  State<SchoolAddCoach3> createState() => _SchoolAddCoach3State();
}

class _SchoolAddCoach3State extends State<SchoolAddCoach3> {
