...
import 'package:permis/screens/autoecole/schoolAddCoach3.dart';
import 'package:shared_preferences/shared_preferences.dart';

import '../../const/vars.dart'; 

class SchoolAddCoach2 extends StatefulWidget {
  const SchoolAddCoach2({Key? key}) : super(key: key);

  @override
  State<SchoolAddCoach2> createState() => _cChoolAddCoach2State();
}

class _cChoolAddCoach2State extends State<SchoolAddCoach2> {
      ...
      floatingActionButton: SizedBox(
        ...
        child: FloatingActionButton.extended(
          ...
          onPressed: () async {
            ...
            Navigator.push(
                context,
                MaterialPageRoute(builder: (context) =>  const SchoolAddCoach3()));
               }
          },
          label: LocaleText(
            "continue",
