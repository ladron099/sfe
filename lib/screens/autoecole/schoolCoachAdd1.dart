...
import 'package:permis/screens/autoecole/schoolAddCoach2.dart';
import 'package:shared_preferences/shared_preferences.dart';

import '../../const/vars.dart';
import '../../functions/apiFunctions.dart'; 

class SChoolCoachAdd1 extends StatefulWidget {
  const SChoolCoachAdd1({Key? key}) : super(key: key);

  @override
  State<SChoolCoachAdd1> createState() => _SChoolCoachAdd1State();
}

class _SChoolCoachAdd1State extends State<SChoolCoachAdd1> {
      ...
      floatingActionButton: SizedBox(
        ...
        child: FloatingActionButton.extended(
          ...
          onPressed: () async {
           ...
           if(fullname.text.isEmpty||date2.text.isEmpty||email.text.isEmpty||cin.text.isEmpty||number.text.isEmpty){
...
showAchievementView(context,false,Locales.string(context, 'emailnonvalide'));
              ...
              ApiFunctions a = ApiFunctions();
prefs.setString('school_id', '$id_school');
print(id_school);

                          log("$dropval $dropdownvalue");
            Navigator.push(
                context, MaterialPageRoute(builder: (context) => const SchoolAddCoach2()));
           }
          },
          label: LocaleText(
            "continue",
