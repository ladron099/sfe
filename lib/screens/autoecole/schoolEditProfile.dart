...
class SchoolEditProfile extends StatefulWidget {
   
  const SchoolEditProfile({Key? key}) : super(key: key);

  @override
  State<SchoolEditProfile> createState() => _SchoolEditProfileState( );
}

class _SchoolEditProfileState extends State<SchoolEditProfile> {
                    ...
                    child: Column(
                      children: [
                        ...
                        input(Locales.string(context, 'telephone'), false,
                            IconlyBroken.lock, phoneNo, false),
                        10.verticalSpace,
                        input(Locales.string(context, 'schooladress'), false,
                            IconlyBroken.notification, address, false),
                        10.verticalSpace,
                        ...
                        RoundedButton(
                          ...
                          () {
                            DeleteAccountPopup(
                              context,
                              'vous voulez supprimer votre profile',
                              data.id,
                              SchoolHomePage(index: 0)
                            );
                          },
      ...
      floatingActionButton: SizedBox(
        ...
        child: FloatingActionButton(
          onPressed: () async {
            ...
            print(workingTime.text);
            sc.city=city.text;
            sc.address=address.text;
            sc.experience=experience.text;
