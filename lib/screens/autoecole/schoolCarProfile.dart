...
class SchoolCarsProfile extends StatefulWidget {
  Cars data;
  SchoolCarsProfile(this.data);

  @override
  State<SchoolCarsProfile> createState() => _SchoolCarsProfileState(data);
}

class _SchoolCarsProfileState extends State<SchoolCarsProfile> {
  bool loading = true;
  final ImagePicker _picker = ImagePicker();
  File image = File('');
  Cars data;
  _SchoolCarsProfileState(this.data);
  ...
  encapp() async {
    ...
    setState(() {
      ...
      dropdownValue = data.status == '1'
          ...
          loading=false;
          print('ld;fjasl;dfjasl;dfjal;sdkfjl;asdfj'+data.status);
    });
  }
