...
class SchoolDetailCandidat extends StatefulWidget {
  int id;
    SchoolDetailCandidat({required this.id, Key? key}) : super(key: key);

  @override
  State<SchoolDetailCandidat> createState() => _SchoolDetailCandidatState(id);
}

class _SchoolDetailCandidatState extends State<SchoolDetailCandidat> {
  ...
  String tarifs = '';
  int id ;
  _SchoolDetailCandidatState(this.id);
getData() async {
