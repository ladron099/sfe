...
import 'package:permis/screens/autoecole/SchoolAddCandidat2.dart'; 
import 'package:shared_preferences/shared_preferences.dart';

import '../../const/vars.dart';
import '../../functions/apiFunctions.dart'; 

class SchoolAddCandidat extends StatefulWidget {
  const SchoolAddCandidat({Key? key}) : super(key: key);

  @override
  State<SchoolAddCandidat> createState() => _SchoolAddCandidatState();
}

class _SchoolAddCandidatState extends State<SchoolAddCandidat> {
...
print(id_school);
            ...
            Navigator.push(
                context, MaterialPageRoute(builder: (context) => const SchoolAddCandidat2()));
           }
